	...
	mywebsite = (function() {
		...
		mywebsite.prototype.animateHomeimg = function() {
			...
			return jQuery("#home .welcome_block").waypoint(function() {
				return new Animo({
					...
					el: jQuery("#home .top_socials li a"),
					duration: 700,
					delay: 1500,
					gap: -65,
					easing: "easeOutBack",
		...
		mywebsite.prototype.animateServices = function() {
			...
			return jQuery("#services").waypoint(function() {
				...
				return new Animo({
					el: jQuery("#services .service_item"),
					duration: 200,
					delay: 10,
					template: {
						left: [-40, 0, "px"],
		...
		mywebsite.prototype.animateAbout = function() {
			...
			return jQuery("#about").waypoint(function() {
				return new Animo({
					...
					el: jQuery("#about .left_block_effect"),
					delay: 700,
					duration: 600,
					template: {
						translateX: [-50, 0, "%"],
		...
		mywebsite.prototype.animateProgress = function() {
			var _this = this;
				return jQuery("#progress").waypoint(function() {
				
				return new Animo({
					el: jQuery("#progress .progress_block li"),
		...
		mywebsite.prototype.animateBlog = function() {
			...
			return jQuery("#blog").waypoint(function() {
				...
				return new Animo({
					...
					el: jQuery("#blog .container.opacity"),
					delay: 700,
					duration: 800,
					template: {
						translateY: [20, 0, "%"],

...
if($_POST)
{
	...
	$to_Email   	= "rajansokhi@gmail.com"; //Replace with recipient email address
	...
	{
		header('HTTP/1.1 500 Please provide a numeric phone number');
		exit();
	}
	...
	if(!$sentMail)
	{
		...
		echo 'Hi '.$user_Name .', Thank you for contacting Annika. ';
		echo ' We will respond to you shortly';
	}
}
?>